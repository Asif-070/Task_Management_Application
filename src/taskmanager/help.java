...
public class help extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Use Completed button to mark a task completed & remove it from the task list");

        jLabel5.setText("Use Failed button to mark a task Failed & remove it from the task list");

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Help");
        setAlwaysOnTop(true);
        setPreferredSize(new java.awt.Dimension(675, 390));
        ...
        getContentPane().add(jToggleButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 230, 27, 27));

        jTextArea1.setEditable(false);
        jTextArea1.setColumns(20);
        jTextArea1.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        jTextArea1.setRows(5);
        jTextArea1.setText("Welcome to Main Menu\n\n     >> Use add button        to add tasks.\n     >> Use delete button        to remove tasks.\n     >> Use refresh button        to refresh main menu.\n     >> Select a task & press more        to see details.\n     >> Use Completed button        to mark a task as completed & remove \nit from the list.\n     >> Use Failed button        to mark a task as Failed & remove it from the list.\n     >> Use Checklist button        to see completed and failed tasks.\n     >> Use Flag button        to see flaged list. ");
        jScrollPane1.setViewportView(jTextArea1);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 6, 660, 300));
